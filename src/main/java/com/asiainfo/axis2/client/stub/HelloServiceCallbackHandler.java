...
public abstract class HelloServiceCallbackHandler {
    ...
    public void receiveResultbyteToString(
        com.asiainfo.axis2.client.stub.HelloServiceStub.ByteToStringResponse result) {
    }
    ...
    public void receiveResultgreeting(
        com.asiainfo.axis2.client.stub.HelloServiceStub.GreetingResponse result) {
    }
    ...
    public void receiveResultgetUser(
        com.asiainfo.axis2.client.stub.HelloServiceStub.GetUserResponse result) {
    }
    ...
    public void receiveResultgetBytes(
        com.asiainfo.axis2.client.stub.HelloServiceStub.GetBytesResponse result) {
    }
    ...
    public void receiveResultsaveUser(
        com.asiainfo.axis2.client.stub.HelloServiceStub.SaveUserResponse result) {
    }
