...
public class HelloServiceUnsupportedEncodingExceptionException extends java.lang.Exception {
    ...
    public void setFaultMessage(
        com.asiainfo.axis2.client.stub.HelloServiceStub.HelloServiceUnsupportedEncodingException msg) {
        faultMessage = msg;
    }

    public com.asiainfo.axis2.client.stub.HelloServiceStub.HelloServiceUnsupportedEncodingException getFaultMessage() {
        return faultMessage;
    }
}
